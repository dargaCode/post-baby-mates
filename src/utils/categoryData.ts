...
export const CATEGORIES: Category[] = [
  {
    ...
    id: CategoryIds.Soup,
    description:
      "Soups come frozen in Quart containers. 1 Quart equals 2 mugs of soup or 1 big bowl of soup. Microwave with the lid OFF at 60% power for 8-10 minutes, stirring at the halfway mark."
  },
  {
    name: "Stews",
    id: CategoryIds.Stew,
